        ...
        <section className="py-20 bg-gradient-to-br from-gray-50 via-blue-50/30 to-cyan-50/40 dark:from-gray-950 dark:via-blue-900/30 dark:to-cyan-900/40">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h1 className="text-4xl md:text-6xl font-bold text-gray-900 dark:text-white mb-6">
              Project <span className="text-brand-gradient">Gallery</span>
            </h1>
            ...
            <div className="mt-8 flex flex-wrap justify-center gap-4">
              <div className={`bg-white/20 dark:bg-gray-900/40 backdrop-blur-sm rounded-xl px-6 py-3 border border-cyan-400/40 ${theme === 'dark' ? 'dark-mode-card-glow' : ''}`}>
                <div className="text-sm sm:text-base font-bold text-cyan-400">Starting @ ₹4,99,999 per set</div>
              ...
              <div className={`bg-white/20 dark:bg-gray-900/40 backdrop-blur-sm rounded-xl px-6 py-3 border border-cyan-400/40 ${theme === 'dark' ? 'dark-mode-card-glow' : ''}`}>
                <div className="text-sm sm:text-base font-bold text-green-400">Starting @ ₹2,00,000+ per set</div>
                <div className="text-[0.6rem] text-gray-600 dark:text-gray-300">Note : 1 Set = 1 lower , 1 upper box</div>
                <div className="text-[0.6rem] text-gray-600 dark:text-gray-300">+ delivery + GST</div>
              </div>
            </div>
